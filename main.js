...
//G-------------------------------------------------------------
console.log("Alguno empiezan con J?");
...
const cambiarAGuion = document.getElementById("button14");
const ejercicio14Filas = document.querySelectorAll(".tr14_fila");
cambiarAGuion.addEventListener("click", function(){
...
const linkFalse = document.getElementById("linkFalso");
linkFalse.addEventListener("click", function(e){
    e.preventDefault;
